...
function main() {
    ...
    if (!gl) {
        console.log('WebGLnichtverfügbar!');
    } else {
        console.log('WebGLverfügbar!');
    }
    ...
    const wuerfel = new Float32Array([
        ...
        /*pos=*/1, -1, 1,/*color=*/0, 1, 0,
        //RÜCKSEITE
        /*pos=*/1, -1, -1,/*color=*/0, 0, 1,/*pos=*/-1, -1, -1,/*color=*/0, 0, 1,/*pos=*/-1, 1, -1,/*color=*/0, 0, 1,/*pos=*/1, -1, -1,/*color=*/0, 0, 1,/*pos=*/-1, 1, -1,/*color=*/0, 0, 1,/*pos=*/1, 1, -1,/*color=*/0, 0, 1,
        //LINKS
        /*pos=*/-1, -1, -1,/*color=*/1, 1, 0,/*pos=*/-1, -1, 1,/*color=*/1, 1, 0,/*pos=*/-1, 1, 1,/*color=*/1, 1, 0,/*pos=*/-1, -1, -1,/*color=*/1, 1, 0,/*pos=*/-1, 1, 1,/*color=*/1, 1, 0,/*pos=*/-1, 1, -1,/*color=*/1, 1, 0,
        //OBEN
        /*pos=*/1, 1, -1,/*color=*/1, 0, 1,/*pos=*/-1, 1, -1,/*color=*/1, 0, 1,/*pos=*/-1, 1, 1,/*color=*/1, 0, 1,/*pos=*/1, 1, -1,/*color=*/1, 0, 1,/*pos=*/-1, 1, 1,/*color=*/1, 0, 1,/*pos=*/1, 1, 1,/*color=*/1, 0, 1,
        //UNTEN
        /*pos=*/-1, -1, -1,/*color=*/0, 1, 1,/*pos=*/1, -1, -1,/*color=*/0, 1, 1,/*pos=*/1, -1, 1,/*color=*/0, 1, 1,/*pos=*/-1, -1, -1,/*color=*/0, 1, 1,/*pos=*/1, -1, 1,/*color=*/0, 1, 1,/*pos=*/-1, -1, 1,/*color=*/0, 1, 1,]);
    ...
    if (!gl.getShaderParameter(vertex_shader, gl.COMPILE_STATUS)) {
        ...
        throw new Error('FehlerbeimKompilierendesVertexShader');
    }
    if (!gl.getShaderParameter(fragment_shader, gl.COMPILE_STATUS)) {
        console.error(gl.getShaderInfoLog(fragment_shader));
        throw new Error('FehlerbeimKompilierendesFragmentShader');
    }
    ...
    if (!gl.getProgramParameter(shader_program, gl.LINK_STATUS)) {
        ...
        throw new Error('FehlerbeimLinkendesShaderProgramms');
    }
    ...
    /*====DefinitioneinerperspektivischenProjektionsmatrix====*/
    const f = 100;
    const n = 0.1;
    ...
    const projektion = new Float32Array([2 * n / (r - l), 0, 0, 0, 0, 2 * n / (t - b), 0, 0, (r + l) / (r - l), (t + b) / (t - b), -(f + n) / (f - n), -1, 0, 0, -2 * f * n / (f - n), 0,]);
    ...
    /*====ZeichnungderPunkteaufdenBildschirm====*/
    ...
    function loop(gl, t) {
        ...
        const x = 2;
        const tz = -9;
        const transformation = new Float32Array([c * x, s * s * x, -c * s * x, 0, 0, c * x, s * x, 0, s * x, -c * s * x, c * c * x, 0, 0, 0, tz, 1,]);
